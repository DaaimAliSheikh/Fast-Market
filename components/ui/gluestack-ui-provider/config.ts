...
export const config = {
  light: vars({
    /* Primary  */
    "--color-primary-0": "224, 240, 255", // Light Blue
    "--color-primary-50": "178, 220, 255", // Soft Sky Blue
    "--color-primary-100": "127, 200, 255", // Light Sky Blue
    "--color-primary-200": "76, 180, 255", // Mid Sky Blue
    "--color-primary-300": "26, 160, 255", // Bright Sky Blue
    "--color-primary-400": "0, 140, 255", // Deep Sky Blue
    "--color-primary-500": "0, 120, 230", // Rich Blue
    "--color-primary-600": "0, 100, 200", // Darker Blue
    "--color-primary-700": "0, 80, 170", // Deep Blue
    "--color-primary-800": "0, 60, 140", // Deeper Blue
    "--color-primary-900": "0, 40, 110", // Very Dark Blue
